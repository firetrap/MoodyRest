...
public class MoodleModAssignGradeReturn implements Serializable{
	...
	public MoodleModAssignGradeReturn() {
	}

	public void addAssignment(MoodleModAssignGrades assignment) {
		if (assignments == null) {
	...
	public MoodleModAssignGrades[] getAssignments() {
		return assignments == null ? null
				: (MoodleModAssignGrades[]) assignments.toArray();
	}

	public MoodleModAssignWarning[] getWarnings() {
		return warnings == null ? null : (MoodleModAssignWarning[]) warnings
				.toArray();
	}
}
